...
public class AmicredApplication {

	private static final Logger LOGGER = LogManager.getLogger(AmicredApplication.class);
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(AmicredApplication.class, args);
	}
